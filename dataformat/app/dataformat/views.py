...
def format_data(request):
    ...
    if request.method == 'POST':
        ...
        name_check = ["name", "fname", "firstname", "first-name", "first_name", "first_name","Name", "Fname", "Firstname", "First-name", "First_name", "First_name"]
        surname_check = ["Lname","lname","surname", "Surname", "sur-name", "Surname", "sur_name", "Sur_name","last_name"]
        card_id_check = ["card_id", "cardid","Card_id", "cardnumber","card_number","Cardnumber","Card_number", "personal_id", "Personal_id", "personal-id", "Personal-id", "id_card_number"]
        address_check = ["address", "Address", "local", "Local",]
        phone_check = ["Phone","phone", "phonenumber", "phone-number", "phone_number", "Phonenumber", "Phone-number", "Phone_number", "tel", "Tel"]
